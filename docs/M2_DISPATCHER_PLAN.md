# Voice Workflow Agent M2 Dispatcher 구현 계획

## 1. 공식 과제와 프로젝트 대응

| 공식 M2 Dispatcher | Voice Workflow Agent |
|---|---|
...
기존 `search_approved_safety_manual`은 유지한다. 따라서 Voice Workflow Agent은
...
Voice Workflow Agent용 M2 Dispatcher를 통합해줘.

요구사항:
1. 원본 week4-brain은 수정하지 말고 voice-workflow-agent에 복사해 작업한다.
