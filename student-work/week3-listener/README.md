...
| Endpoint silence | 40 frames / 800 ms | Preserve ordinary mid-thought pauses |
...
```bash
cd student-work/week3-listener
python3 -m venv .venv
...
- There is no conversation history, semantic endpointing, Silero, native
  speech-to-speech, tools, persona, authentication, or rate limiting.
