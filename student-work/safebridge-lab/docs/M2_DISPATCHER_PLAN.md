# SafeBridge Lab M2 Dispatcher 구현 계획

## 1. 공식 과제와 프로젝트 대응

| 공식 M2 Dispatcher | SafeBridge Lab |
|---|---|
...
기존 `search_approved_safety_manual`은 유지한다. 따라서 SafeBridge Lab은
...
```text
현재 브랜치의 student-work/week4-brain을 읽고, 기존 M3 Hands-free VAD와
M4 Streaming TTS·Memory·search_approved_safety_manual 동작을 보존한 채
SafeBridge Lab용 M2 Dispatcher를 통합해줘.

요구사항:
1. 원본 week4-brain은 수정하지 말고 student-work/safebridge-lab에 복사해 작업한다.
