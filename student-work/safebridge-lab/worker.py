...
from tools import INBOX_PATH, OUTBOX_DIR, PROCESSED_PATH, STATUS_DIR
...
def write_handoff_email(
    ...
    message["Subject"] = (
        f"{prefix}SafeBridge Lab 보고 {report['id']} — {report['location']}"
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SafeBridge Lab report worker")
